            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1 space-y-5 self-center">
                <div>
                  ...
                  <p className="text-3xl font-bold text-[#111418] dark:text-white leading-tight mb-2">
                    {property.address}
                  </p>
              ...
              <table className="w-full text-left border-collapse">
                <thead className="bg-gray-50 dark:bg-[#1e2a3b] border-b-2 border-primary">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-[9px] font-bold uppercase text-[#617289] dark:text-[#9ca3af] tracking-widest">Área Ocupada</th>
                ...
                <tbody className="divide-y divide-gray-50 dark:divide-gray-700/50 text-sm">
                  {(() => {
                    ...
                    if (yearTenants.length === 0) {
                      return (
                        <tr>
                          <td colSpan={4} className="px-6 py-12 text-center text-[#617289] dark:text-[#9ca3af] font-semibold italic opacity-60">Nenhum locatário cadastrado para {selectedYear}.</td>
                        </tr>
                      );
                    }
                    ...
                    return yearTenants.map((tenant) => {
                      ...
                      return (
                        <tr key={tenant.id} className="hover:bg-primary/5 dark:hover:bg-primary/10 transition-colors group">
                          ...
                          <td className="px-6 py-4 font-semibold text-[#617289] dark:text-[#9ca3af]">{tenant.occupiedArea.toLocaleString('pt-BR')} m²</td>
